...
<div id="social-share">
    ...
    <div class="social-open-menu">
        <button style="font-size: 10px;color: #000;" class="btn-share btn-shake">تماس با ما</button>
    </div>
</div>
...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/main.js?ver=1.0.14"></script>
</body>
