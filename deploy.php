<?php
//shell_exec('cd /home/negareno/public_html/wp-content/themes/novin && /usr/local/cpanel/3rdparty/lib/path-bin/git reset --hard HEAD && /usr/local/cpanel/3rdparty/lib/path-bin/git pull -q origin master	');
//return;
/**
 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'Aa0123456789');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/nouri6412/novin.git');
 ...
 * @var string
 */
if (!defined('SECRET_ACCESS_TOKEN')) define('SECRET_ACCESS_TOKEN', 'Aa0123456789');
 ...
 * @var string
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'https://github.com/nouri6412/novin.git');
 ...
 * @var string Full path including the trailing slash
 */
if (!defined('TMP_DIR')) define('TMP_DIR', TARGET_DIR.'spgd-'.md5(REMOTE_REPOSITORY).'/');
...
if (!isset($_GET['sat']) || $_GET['sat'] !== SECRET_ACCESS_TOKEN || SECRET_ACCESS_TOKEN === 'Aa0123456789') {
...
if (SECRET_ACCESS_TOKEN === 'Aa0123456789') {
//	header($_SERVER['SERVER_PROTOCOL'] . ' 403 Forbidden', true, 403);
